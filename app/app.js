...
%%EOF`;
  ...
  function AccountSheet({ acc, onClose }) {
    ...
    return /* @__PURE__ */ React.createElement(Sheet, { onClose, z: 70 }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 21, letterSpacing: "-0.015em", marginBottom: 16 } }, "Minu konto"), /* @__PURE__ */ React.createElement(Panel, { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement(Label, null, "Konto"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 600, marginBottom: 12 } }, authUser.email), /* @__PURE__ */ React.createElement(Btn, { full: true, onClick: signOutUser }, "Logi v\xE4lja")), /* @__PURE__ */ React.createElement(Panel, { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement(Label, null, "Teavitused"), notifPerm === "unsupported" ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: T.faint, lineHeight: 1.5 } }, "See brauser ei toeta teavitusi.") : notifPerm === "denied" ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: T.faint, lineHeight: 1.5 } }, "Teavitused on brauseri tasandil blokeeritud. Luba need brauseri/telefoni seadetest saidi jaoks, et siin sisse l\xFClitada.") : !notifPrefs.enabled || notifPerm !== "granted" ? /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, color: T.faint, lineHeight: 1.5, marginBottom: 12 } }, 'Saad teada, kui m\xF5ni toode l\xE4heb "otsas" olekusse \u2014 nii ei pea ise nimekirja kontrollima k\xE4ima. T\xF6\xF6tab k\xF5ige paremini siis, kui \xE4pp on hiljuti avatud olnud.'), /* @__PURE__ */ React.createElement(Btn, { kind: "solid", full: true, onClick: requestNotif }, "Luba teavitused")) : /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "flex",
